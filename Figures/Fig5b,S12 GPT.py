...
data_path = str(Path(os.getcwd()).parent) + '/Data/Fig5b,S12 GPT/'

D2 = np.load(data_path+'r_squared_D2.npz')
D4 = np.load(data_path+'r_squared_D4.npz')
D6 = np.load(data_path+'r_squared_D6.npz')
D8 = np.load(data_path+'r_squared_D8.npz')
D10 = np.load(data_path+'r_squared_D10.npz')
...
D2_ang = np.load(data_path+'decoders_D2.npz')
D4_ang = np.load(data_path+'decoders_D4.npz')
D6_ang = np.load(data_path+'decoders_D6.npz')
D8_ang = np.load(data_path+'decoders_D8.npz')
D10_ang = np.load(data_path+'decoders_D10.npz')
